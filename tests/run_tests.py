...
for filename in filenames:
    ...
    for l in lengths:
        ...
        result = str(col_results == dc3_results) # En lugar de esto que se fije si uko_results = col_results = dc3_results

        out.write(filename + "\t" + str(len(t1)) + "\t" + str(len(set(t1))) + "\t" + p + "\t" + "{0:.3f}".format(
