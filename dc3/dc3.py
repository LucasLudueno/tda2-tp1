class DC3(object):
    ...
    def sort_samples(self, t, x):
        ...
        # Si no tiene duplicados, ya esta
    ...
    def sort_non_samples(self, t, rank):
        ...
        # El "i" que esta en la tercera posicion no se usa para ordenar

        # sorted_non_samples = sorted(sorted_non_samples)
        sorted_non_samples.sort()
        # Me quedo solo con los indices ordenados, el resto no lo necesito por ahora
